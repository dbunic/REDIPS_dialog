...
return str;};return{op_high:op_high,op_low:op_low,fade_speed:fade_speed,youtube:youtube,close_button:close_button,init:init,show:show,hide:hide};}());if(!REDIPS.event){REDIPS.event=(function(){var add,remove;add=function(obj,eventName,handler){if(obj.addEventListener){obj.addEventListener(eventName,handler,false);}
