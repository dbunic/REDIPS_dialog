...
return xmlhttp;};show=function(width,height,text,button1,button2){var input1='',input2='',param='',img_extensions,page_extensions,youtube_url,youtube_html='',div_img='',div_text='',img_text='';REDIPS.dialog.shown=true;dialog_width=width;dialog_height=height;position();img_extensions=/(\.jpg|\.jpeg|\.gif|\.png)$/i;page_extensions=/(\.php|\.html|\.aspx)/i;youtube_url=/www\.youtube\.com/i;if(button1!==undefined){input1=input_html(button1);}
